...
\fancypagestyle{firststyle}{ %Style of the first page
 ...
 \lhead{\includegraphics[scale=0.8]{./img/fhnw_logo.jpg}}
...
\fancypagestyle{documentstyle}{ %Style of the rest of the document
 ...
 \fancyheadoffset[L]{0.6cm}
 \lhead{\includegraphics[scale=0.8]{./img/fhnw_logo.jpg}}
 \rhead{\includegraphics[scale=0.3]{./img/mse_logo.jpg}}
 \renewcommand{\headrulewidth}{0pt}
...
\input{./chapters/02_deep_speech.tex}
\clearpage

\input{./chapters/03_language_model.tex}
\clearpage

\input{./chapters/04_learning_curve.tex}
\clearpage

\input{./chapters/05_pipeline_evaluation.tex}
\clearpage

\input{./chapters/06_other_languages.tex}
\clearpage
...
\newpage
\input{./chapters/00_disclaimer.tex}
\end{document}